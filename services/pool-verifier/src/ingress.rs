...
/// four heartbeats (PB-51), 6 to 8 s at 2 s, or up to about 14 s when a
/// template write is what the black hole swallows; by then the dead socket
/// is past its threshold. The shed does nothing for refusals by the global cap, and
