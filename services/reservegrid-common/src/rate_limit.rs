...
//!
//! Features:
//! - Sliding window (no burst doubling at bucket edges)
...
mod tests {
    ...
    #[test]
    fn window_rollover_allows_requests_again() {
        let limiter = RateLimiter::new();
    ...
    #[test]
    fn sliding_window_no_boundary_doubling() {
